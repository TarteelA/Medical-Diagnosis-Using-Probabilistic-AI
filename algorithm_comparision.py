...
url = "Data/Parkinson/parkinsons_data-VOICE-features.csv"
# feature names
features = ["MDVPFoHz","MDVPFhiHz","MDVPFloHz","MDVPJitter","MDVPJitterAbs","MDVPRAP","MDVPPPQ","JitterDDP","MDVPShimmer","MDVPShimmerdB","ShimmerAPQ3","ShimmerAPQ5","MDVPAPQ","ShimmerDDA","NHR","HNR","RPDE","DFA","spread1","spread2","D2","PPE","status"]
