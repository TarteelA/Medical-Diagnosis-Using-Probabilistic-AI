...
if __name__ == "__main__":
    if len(sys.argv) < 4 or len(sys.argv) > 5:
        print("USAGE: BayesNetInference.py [inference_algorithm] [config_file.txt] [query] (num_samples)")
        print("EXAMPLE1> BayesNetInference.py InferenceByEnumeration config.txt \"query\"")
        print("EXAMPLE2> BayesNetInference.py RejectionSampling config.txt \"query\" 10000")
        exit(0)
